...
const Layout = ({ onLogout, user }) => {
  ...
  const StatCard = ({ title, value, icon }) => (
    <div
      className="p-2 sm:p-3 rounded-xl bg-white shadow-sm border border-purple-100 hover:shadow-md transition-all
    duration-300 hover:border-purple-300 group"
    >
  ...
  if (error)
    return (
      <div className="min-h-screen bg-gray-50 p6 flex items-center justify-center">
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="relative pt-1">
                  <div className="flex gap-1.5 items-center">
                    <div className="flex-1 h-2 sm:h-3 b bg-purple-100 rounded-full overflow-hidden">
                      <div
                ...
                {tasks.slice(0, 3).map((task) => (
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sx text-gray-500 mt-0.5">
                        {task.createdAt
