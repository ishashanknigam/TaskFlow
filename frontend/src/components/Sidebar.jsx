      ...
      <div className={SIDEBAR_CLASSES.desktop}>
        <div className="p-5 border-b border-purple-100 lg:block hidden">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-fuchsia-500 to-purple-500 flex items-center justify-center text-white shadow-md">
              {initial}
            </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className={TIP_CARD.text}>
                    Use Keyboard to boost productivity!
                  </p>
                  <a
                    href="/"
                    target="_blank"
        ...
        <div className="fixed inset-0 z-40">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 mt-9 rounded-full bg-gradient-to-br from-fuchsia-500 to-purple-500 flex items-center justify-center text-white shadow-md">
                {initial}
              </div>

              <div>
                <h2 className="text-lg mt-8 font-bold text-gray-800">
                  Hey, {username}
                </h2>
